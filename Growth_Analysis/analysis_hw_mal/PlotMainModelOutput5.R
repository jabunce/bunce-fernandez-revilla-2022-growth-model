...
symbol.Male(centerx = 23, centery = 150, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
pdf(file="./Plots/Composite_model_Q.pdf",
  ...
  plot( x=0, y=60, type="n", ylim=c(0.07,max(c(rowMeans(tQmat),rowMeans(tQber)))), xlim=c(0,26), axes=F, ylab=NA, xlab=NA )
  axis( side=2, at=seq(0.09,0.17,0.01), las=1 )
  axis( side=1, at=seq(0,25,5), las=1 )
  box(col = "black") 
  par(xpd=FALSE)
  ...
  plot( x=0, y=0, type="n", ylim=c(-1*max(abs(rowMeans(conQ)))-0,max(abs(rowMeans(conQ)))+0.05), xlim=c(0,26), axes=F, ylab=NA, xlab=NA)
  ...
  polygon(c(a, rev(a)), c(ints[,2], rev(ints[,1])), 
        col = gray(0.5,alpha=0.5), border=NA)
  ...
  legend(-1, max(abs(rowMeans(conQ)))+0.01,       #x="topleft", inset=c(0,-0.5), 
...
symbol.Male(centerx = 23, centery = max(abs(rowMeans(conQ)))+0.01, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
pdf(file="./Plots/Composite_model_K.pdf",
  ...
  #set up plot
  par(mar=c(5, 6, 2, 6), oma = c(1, 1, 1, 1)) #c(bottom, left, top, right)
  plot( x=0, y=60, type="n", ylim=c(5,max(c(rowMeans(tKmat),rowMeans(tKber)))-58), xlim=c(0,26), axes=F, ylab=NA, xlab=NA )
  axis( side=2, at=seq(8,24,4), las=1 )
  axis( side=1, at=seq(0,25,5), las=1 )
  box(col = "black") 
  par(xpd=FALSE)
  ...
  plot( x=0, y=0, type="n", ylim=c(-1*max(abs(rowMeans(conK)))+0.5,max(abs(rowMeans(conK)))+6), xlim=c(0,26), axes=F, ylab=NA, xlab=NA)
  axis( side=4, at=c(-0.5, 0, 0.5), labels=c(-0.5, 0, 0.5), las=2 )
  par(xpd=FALSE)
  ...
  legend(-1, max(abs(rowMeans(conK)))+1,       #x="topleft", inset=c(0,-0.5), 
         text.width=textwidths, #x=c(0.0085,0.01), y=c(1,0.5), #mean(exp(post$berLQ1)) - 0.0005, 1.4,
         legend=legtext, bty="o", bg="white",
         col=c(colorlist["2.3"], colorlist["1.3"], "black","white"),
         lty=c(1,1,1,1),
...
symbol.Male(centerx = 23, centery = max(abs(rowMeans(conK)))+1, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
pdf(file="./Plots/Composite_model_H.pdf",
  ...
  #set up plot
  par(mar=c(5, 6, 2, 6), oma = c(1, 1, 1, 1)) #c(bottom, left, top, right)
  plot( x=0, y=60, type="n", ylim=c(4,max(c(rowMeans(tHmat),rowMeans(tHber)))-39), xlim=c(0,26), axes=F, ylab=NA, xlab=NA )
  axis( side=2, at=seq(6,18,4), las=1 )
  axis( side=1, at=seq(0,25,5), las=1 )
  box(col = "black") 
  par(xpd=FALSE)
  ...
  plot( x=0, y=0, type="n", ylim=c(-1*max(abs(rowMeans(conH)))+0.5,max(abs(rowMeans(conH)))+6), xlim=c(0,26), axes=F, ylab=NA, xlab=NA)
  axis( side=4, at=c(-0.5, 0, 0.5), labels=c(-0.5, 0, 0.5), las=2 )
  par(xpd=FALSE)
  ...
  legend(-1, max(abs(rowMeans(conH)))+1,       #x="topleft", inset=c(0,-0.5), 
         text.width=textwidths, #x=c(0.0085,0.01), y=c(1,0.5), #mean(exp(post$berLQ1)) - 0.0005, 1.4,
         legend=legtext, bty="o", bg="white",
         col=c(colorlist["2.3"], colorlist["1.3"], "black","white"),
         lty=c(1,1,1,1),
...
symbol.Male(centerx = 23, centery = max(abs(rowMeans(conH)))+1, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
layout( matrix(c(1,2,3,4,5,6,7,8), 4, 2, byrow = FALSE),
        heights=c(1,1,1,1),
        widths=c(1,1) )
par(mar = c(2, 1, 2, 0), oma = c(5, 7, 4, 4)) #margins for indiv plot, oma for outer margins (bottom, left, top, right)
...
I1_plot <- denschart3( mean_I_list[c(1,2)],
            ...
            colorHPDI=c( colorlist["1.3"], #rgb(0,0,1,max=1,alpha=0.5),          #rgb:  red, green, blue, alpha=0 is opaque
                         colorlist["2.3"] #rgb(1,0,0,max=1,alpha=0.5)
                        ),
            polyborder=c( colorlist["1.1"],
                          colorlist["2.1"]
                        ),
            polyborderHPDI=c( colorlist["1.1"],
                              colorlist["2.1"]
                            ),
            HPDI=0.9,
            border=NA, yaxt="n",
            ...
            xlim=range(0.12,0.13),        #( mean( mean_I_list$I1mat ) - 1, mean( mean_I_list$I1ber ) + 1 ), #( 85, 100 ),
            yvals = c(0.5,
                      0.5)
 )

lines(x=c( mean( mean_I_list$I1mat ), mean( mean_I_list$I1mat ) ),
      y=c(0,0.75), col=colorlist["1.1"], lwd=3, lty=1)
lines(x=c( mean( mean_I_list$I1ber ), mean( mean_I_list$I1ber ) ),
      y=c(0,0.75), col=colorlist["2.1"], lwd=3, lty=1)
...
textwidths[1] <- 0 # so replace element 1 with a finite number (any will do)
  ...
  legend(x="topleft", inset=c(0,0), text.width=textwidths, #x=c(0.0085,0.01), y=c(1,0.5), #mean(exp(post$berLQ1)) - 0.0005, 1.4,
         legend=legtext, bty="o", bg="white",
         col=c(colorlist["2.1"], colorlist["1.1"], "black","white"),
         lty=c(1,1,1,1),
         lwd=c(3,3,3,3),
         cex=1.4,
         x.intersp=0.5,
...
mtext(expression(paste(bolditalic("i")[2])), side = 1, outer = T, cex = 1.5, adj=-0.3, line = -0.5 )
mtext(expression(paste(bolditalic("i")[3])), side = 1, outer = T, cex = 1.5, adj=-0.3, line = 8.5 )
mtext(expression(paste(bolditalic("i")[4])), side = 1, outer = T, cex = 1.5, adj=-0.3, line = 17.5 )
mtext(expression(paste(bolditalic("i")[5])), side = 1, outer = T, cex = 1.5, adj=-0.3, line = 26 )
...
I2_plot <- denschart3( mean_I_list[c(3,4)],
            ...
            cex=0.8, height=0.4,
            #clip(-0.5, 21, 0, 2), #clip(x1, x2, y1, y2) clips drawing beyond the rectangle
            xlim=range(0.7,0.8),        #( mean( mean_I_list$I2mat ) - 0.2, mean( mean_I_list$I2ber ) + 0.2),
            yvals = c(0.5,
                      0.5)
 )
...
I3_plot <- denschart3( mean_I_list[c(5,6)],
            ...
            cex=0.8, height=0.4,
            #clip(-0.5, 21, 0, 2), #clip(x1, x2, y1, y2) clips drawing beyond the rectangle
            xlim=range(2.3,2.8),        #( mean( mean_I_list$I3mat ) - 1, mean( mean_I_list$I3ber ) + 1),
            yvals = c(0.5,
                      0.5)
 )
...
I4_plot <- denschart3( mean_I_list[c(7,8)],
            ...
            cex=0.8, height=0.4,
            #clip(-0.5, 21, 0, 2), #clip(x1, x2, y1, y2) clips drawing beyond the rectangle
            xlim=range(10,12),        #( mean( mean_I_list$I4mat ) - 1, mean( mean_I_list$I4ber ) + 1),
            yvals = c(0.5,
                      0.5)
 )
...
axis(side=1, at=c(-0.01,0.01), labels=c(-0.01,0.01), cex.axis=1.5)
...
contr_char_list <- list(mean_char_list$berMaxHeight - mean_char_list$matMaxHeight,
                        mean_char_list$berMaxVelAge - mean_char_list$matMaxVelAge,
                        mean_char_list$berMaxVel - mean_char_list$matMaxVel)
...
axis(side=1, at=c(160,180), labels=c(160,180), cex.axis=1.5)
...
axis(side=1, at=c(13.5,14), labels=c(13.5,14), cex.axis=1.5)
