...
# on mac
#setwd("/Users/johnbunce/Dropbox/Matsigenka-Mestizo_project_2014/health_analysis/growth_fitting_analysis/growth_11dec24/Matsigenka/analysis_hwfull_mal")
# on pc
#setwd("C:/Users/John/Dropbox/Matsigenka-Mestizo_project_2014/health_analysis/growth_fitting_analysis/growth_11dec24/Matsigenka/analysis_hwfull_mal")
# on server
setwd("~/Matsigenka/analysis_hwfull_mal")
...
samps <- 1000 	#6000 number of mcmc samples
num_chains <- 2 #4 number of mcmc chains
...
samps <- 5000 	#number of mcmc samples
