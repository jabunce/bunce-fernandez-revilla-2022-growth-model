...
parameters {
  ...
  real<lower=0,upper=0.005> Lsigma_h;        // 0..01 0.005 0.01     variance of the logged normal distribution, upper limit of 0.005 yields 95% of observations within 2*stdev = 1cm of actual height at 100cm, within 0.5kg of actual weight at 50kg
  real<lower=0,upper=0.005> Lsigma_w;           //0.01 0.005 0.11, 0.13, 0.15, 0.2, 0.1, 0.8, nothing,
