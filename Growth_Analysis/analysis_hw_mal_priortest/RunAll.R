...
# on mac
#setwd("/Users/johnbunce/Dropbox/Matsigenka-Mestizo_project_2014/health_analysis/growth_fitting_analysis/growth_12apr25/Matsigenka/analysis_hw_mal_priortest")
# on pc
setwd("C:/Users/John/Dropbox/Matsigenka-Mestizo_project_2014/health_analysis/growth_fitting_analysis/growth_12apr25/Matsigenka/analysis_hw_mal_priortest")
# on server
#setwd("~/Matsigenka/analysis_hw_mal_priortest")
...
samps <- 1000 #4000 	#number of mcmc samples
