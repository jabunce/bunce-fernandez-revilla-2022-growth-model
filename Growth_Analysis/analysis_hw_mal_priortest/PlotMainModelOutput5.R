...
pdf(file="./Plots/Composite_model_sample_mat_ber_randeff_cov5h.pdf",
  ...
  points(x=Ber.mal$TotAge, y=Ber.mal$Height, lwd=BerPoint_lwd, col=BerPoint_col, cex=BerPoint_cex)
  points(x=Mat.mal$TotAge, y=Mat.mal$Height, lwd=MatPoint_lwd, col=MatPoint_col, cex=MatPoint_cex)
...
pdf(file="./Plots/Composite_model_sample_mat_ber_randeff_cov5w.pdf",
  ...
  # plot measurment points
  points(x=Ber.mal$TotAge, y=Ber.mal$CellWeightg, lwd=BerPoint_lwd, col=BerPoint_col, cex=BerPoint_cex)
  points(x=Mat.mal$TotAge, y=Mat.mal$CellWeightg, lwd=MatPoint_lwd, col=MatPoint_col, cex=MatPoint_cex)
...
symbol.Male(centerx = 23, centery = 350, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
pdf(file="./Plots/params_combined_m_priortest.pdf",
    height=10, width=10)
...
symbol.Male(  centerx = 5, centery = 11.6, rayonx=0.4, lwd=1.5, col="black")
