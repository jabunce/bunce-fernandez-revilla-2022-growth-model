...
# priors from fit to Matsigenka females
muQ1 <- 0.08454261 ##0.0843463 #0.08637589 #0.09691564 #0.08838383 ##0.08631607  
muQ2 <- 0.16614573 ##0.1635835 #0.1649906 #0.1854612 #0.1701386 ##0.1658155   
muQ3 <- 0.30624950 ##0.301474 #0.179 #0.303743 #0.1991625 ##0.2082999   
muQ4 <- 0.04726658 ##0.04490953 #0.0543 #0.04376139 #0.05003629 ##0.3358043  
muQ5 <- 0.12388952 ##0.1185199 #0.126 #0.1094167 #0.1158356 ##0.4211652 

muK1 <- 81.941305 ##80.56134 #75.36287 #73.5461 #69.26481 ##74.50596  
muK2 <- 12.564960 ##11.89951 #12.0736 #11.38923 #9.749453 ##12.2533  
muK3 <- 1.556003 ##1.519152 #3.48 #1.830075 #2.802159 ##3.928223  
muK4 <- 10.273722 ##9.621323 #7.9 #10.15139 #8.473641 ##1.517058    
muK5 <- 8.587737 ##7.928997 #6.42 #7.927593 #6.974529 ##2.713713 

muH1 <- 57.618558 ##56.92423 #53.58602 #54.4514 #50.00313 ##53.16193
muH2 <- 10.566646 ##10.23521 #10.22789 #10.59861 #8.616612 ##10.30698
muH3 <- 2.531036 ##2.559665 #3.3 #2.972541 #2.899098 ##4.048139
muH4 <- 5.787023 ##5.461462 #4.75 #5.834366 #4.991565 ##2.655676
muH5 <- 5.988818 ##5.599069 #4.81 #5.524491 #5.130509 ##4.973799  

muI1 <- 0
muI2 <- 0.1218582 ##0.1220897 #0.1241712 #0.1213675 #0.1261745 ##0.1248041    
muI3 <- 0.7337505 ##0.7174615 #0.765 #0.8543406 #0.7586653 ##0.6130044 
muI4 <- 2.5314756 ##2.528105 #5 #1.88 #2.212005 #1.81026 ##4.664357  
muI5 <- 9.7955701 ##11.08915 #10.6 #10.83705 #10.52904 ##12.00318 
...
gexpLQ1 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.001 #0.0001
gexpLQ2 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.001 #0.0001       
gexpLQ3 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.001 #0.0001
gexpLQ4 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.001 #0.0001        
gexpLQ5 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.001 #0.0001

gexpLK1 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.0001      
gexpLK2 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.0001 
gexpLK3 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.01 #0.0001 
gexpLK4 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.01 #0.0001 
gexpLK5 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.01 #0.0001 

gexpR1 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.0001 #0.1 #0.001 #0.0001 #1 #5 #0.0001       
gexpR2 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.01 #0.001 #0.0001 #0.1 #1 #0.0001
gexpR3 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.005 #0.001 #0.0001 #0.05 #0.5 #0.0001
gexpR4 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.005 #0.001 #0.0001 #0.05 #0.5 #0.0001
gexpR5 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.005 #0.001 #0.0001 #0.05 #0.5 #0.0001

gexpLI1 <- 0.0000001      
gexpLI2 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.01 #0.0001
gexpLI3 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.01 #0.0001
gexpLI4 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.01 #0.0001
gexpLI5 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.003 #0.001 #0.0001 #0.01 #0.01 #0.0001
gexpLIM <- 0.0000001
...
iexpLQ1 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.001
iexpLQ2 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.001       
iexpLQ3 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.001 
iexpLQ4 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.001         
iexpLQ5 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.001 

iexpLK1 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.01 #0.001       
iexpLK2 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.01 #0.001
iexpLK3 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.01 #0.001  
iexpLK4 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.01 #0.001
iexpLK5 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.01 #0.001

iexpR1 <- 0.003 #0.005 #0.01 #0.001 #0.001 #0.1 #0.001 #0.1 #0.01 #0.001      
iexpR2 <- 0.003 #0.005 #0.01 #0.001 #0.01 #0.001 #0.01 #0.01 #0.001
iexpR3 <- 0.003 #0.005 #0.01 #0.001 #0.005 #0.001 #0.005 #0.01 #0.001
iexpR4 <- 0.003 #0.005 #0.01 #0.001 #0.005 #0.001 #0.005 #0.01 #0.001
iexpR5 <- 0.003 #0.005 #0.01 #0.001 #0.005 #0.001 #0.005 #0.01 #0.001

iexpLI1 <- 0.0000001      
iexpLI2 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.05 #0.01 #0.001
iexpLI3 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.05 #0.01 #0.001 
iexpLI4 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.05 #0.01 #0.001 
iexpLI5 <- 0.003 #0.005 #0.01 #0.001 #0.003 #0.001 #0.01 #0.05 #0.01 #0.001
iexpLIM <- 0.0000001
...
# on transformed scale 
ihsdLQ1 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdLQ2 <- 0.003 #0.005 #0.01 #0.001 #0.000001        
ihsdLQ3 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdLQ4 <- 0.003 #0.005 #0.01 #0.001 #0.000001          
ihsdLQ5 <- 0.003 #0.005 #0.01 #0.001 #0.000001 

ihsdLK1 <- 0.003 #0.005 #0.01 #0.001 #0.000001     
ihsdLK2 <- 0.003 #0.005 #0.01 #0.001 #0.000001 
ihsdLK3 <- 0.003 #0.005 #0.01 #0.001 #0.000001  
ihsdLK4 <- 0.003 #0.005 #0.01 #0.001 #0.000001  
ihsdLK5 <- 0.003 #0.005 #0.01 #0.001 #0.000001 

ihsdR1 <- 0.003 #0.005 #0.01 #0.001 #0.000001      
ihsdR2 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdR3 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdR4 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdR5 <- 0.003 #0.005 #0.01 #0.001 #0.000001

ihsdLI1 <- 0.0000001      
ihsdLI2 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdLI3 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdLI4 <- 0.003 #0.005 #0.01 #0.001 #0.000001
ihsdLI5 <- 0.003 #0.005 #0.01 #0.001 #0.0000001
ihsdLIM <- 0.0000001
