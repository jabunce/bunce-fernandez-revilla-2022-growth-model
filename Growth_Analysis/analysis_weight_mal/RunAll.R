...
# on mac
#setwd("/Users/johnbunce/Dropbox/Matsigenka-Mestizo_project_2014/health_analysis/growth_fitting_analysis/growth_github/analysis_weight_mal")
# on pc
#setwd("C:/Users/John/Dropbox/Matsigenka-Mestizo_project_2014/health_analysis/growth_fitting_analysis/growth_github/analysis_weight_mal")
# on server
setwd("~/growth_github/analysis_weight_mal")
...
# plot model posterior growth curves against LMS curve
...
# estimate indiv-level stdev by fitting model with indiv-level random effects to simulated indiv trajectories CDC data (m4)
...
# design priors for reasonable overall stdev and group-level stdev
