...
pdf(file="./Plots/Composite_ber_m1_mw.pdf",
    height=5, width=5)
  ...
  plot( x=0, y=60, type="n", ylim=c(0,120), xlim=c(0,26), xlab="Age since conception (yrs)", ylab="Weight (kg)" )


  # plot measurment points
  points(x=Ber.mal$TotAge, y=Ber.mal$Weight, lwd=1, col=grey(0.5), cex=0.5)
...
symbol.Male(centerx = 5, centery = 7, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
