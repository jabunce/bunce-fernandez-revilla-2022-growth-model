...
# priors come from this model fit to male data
muQ1 <- 0.0843463 #0.08847203 #0.08637589 #0.02642435 #0.02788939 #0.01846999 #0.018 #0.02788939 #0.029 #0.004 
muQ2 <- 0.1635835 #0.1587478 #0.1649906 #0.2427418 #0.2574765 #0.2382693 #0.23 #0.2574765 #0.27 #0.051 
muQ3 <- 0.301474 #0.2679658 #0.2088067 #0.2289767 #0.2393313 #0.2224999 #0.23 #0.2393313 #0.249 #0.1 
muQ4 <- 0.04490953 #0.05452986 #0.344921 #0.2653013 #0.2620346 #0.3331369 #0.33 #0.2620346 #0.251 #0.25 
muQ5 <- 0.1185199 #0.1347944 #0.4512731 #0.497431 #0.4926697 #0.4915381 #0.49 #0.4926697 #0.48 #0.55 

muK1 <- 80.56134 #74.07334 #75.36287 #297.2281 #278.8385 #453.1015 #465.2 #278.8385 #267 #2955 
muK2 <- 11.89951 #11.88812 #12.0736 #15.22311 #14.47897 #11.07146 #11 #14.47897 #13.6 #92.5 
muK3 <- 1.519152 #1.958709 #3.945743 #6.092474 #5.864563 #3.670478 #3.65 #5.864563 #5.5 #16.3 
muK4 <- 9.621323 #8.800723 #1.609368 #1.756456 #1.764828 #1.61489 #1.57 #1.764828 #1.79 #1.75  
muK5 <- 7.928997 #6.966991 #2.801749 #2.582605 #2.613814 #3.049673 #3 #2.613814 #2.7 #2.5 

muH1 <- 56.92423 #53.11016 #53.58602 #165.0675 #155.8867 #243.9172 #250 #155.8867 #150 #1500 
muH2 <- 10.23521 #10.13231 #10.22789 #16.54593 #16.13737 #12.35944 #12 #16.13737 #15.6 #54.4 
muH3 <- 2.559665 #2.743391 #4.074629 #6.217122 #6.124631 #4.003799 #4 #6.124631 #6 #11.3 
muH4 <- 5.461462 #5.104311 #2.731963 #2.48548 #2.474928 #2.634141 #2.57 #2.474928 #2.4 #2.4
muH5 <- 5.599069 #5.116393 #5.027771 #5.243103 #5.270818 #5.797311 #5.8 #5.270818 #5.3 #6 

muI1 <- 0
muI2 <- 0.1220897 #0.1297911 #0.1241712 #0.4521714 #0.5014537 #0.2972938 #0.4 #0.5014537 #0.6 #0.125 
muI3 <- 0.7174615 #0.72 ##0.7502159 #0.6008812 #1.02903 #1.010873 #1.074176 #1.1 #1.010873 #1 #0.3 
muI4 <- 2.528105 #1.979483 #4.500285 #2.234554 #2.173383 #4.43865 #4.4 #2.173383 #2.2 #1.5 
muI5 <- 11.08915 #9.107902 #10.17578 #9.928083 #9.95563 #10.4425 #10.35 #9.95563 #10.2 #10.2 
...
gexpLQ1 <- 0.003 #0.0001 #0.001 #0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.0001 #0.001  # mean(post5$"offsetIndivStdevs[1]")
gexpLQ2 <- 0.003 #0.0001 #0.001 #0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.0001 #0.001        
gexpLQ3 <- 0.003 #0.0001 #0.0001 #0.001 #0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.0001 #0.001
gexpLQ4 <- 0.003 #0.0001 #0.001 #0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.0001 #0.001 #0.005 ##0.001        
gexpLQ5 <- 0.003 #0.0001 #0.001 #0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.0001 #0.001 ##0.005

gexpLK1 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.005      
gexpLK2 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.005 
gexpLK3 <- 0.003 #0.0001 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.005 
gexpLK4 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.005 #0.01 ##0.005 
gexpLK5 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.005  #0.01 ##0.001 

gexpR1 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01       
gexpR2 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01
gexpR3 <- 0.003 #0.0001 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01
gexpR4 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01 #0.05 ##0.01
gexpR5 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01 ##0.05

gexpLI1 <- 0.00000001      
gexpLI2 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001
gexpLI3 <- 0.003 #0.0001 #0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01 ##0.001
gexpLI4 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01 ##0.001
gexpLI5 <- 0.003 #0.005 #0.01 #0.001 #0.0001 #0.001 #0.00001 #0.001 #0.01 ##0.001
gexpLIM <- 0.00000001
