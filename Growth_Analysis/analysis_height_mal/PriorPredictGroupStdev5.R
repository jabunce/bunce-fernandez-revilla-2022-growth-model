...
muQ1 <- 0.07703198 #0.08613371 #0.08619359 #0.0864 #0.088 #0.098 #0.094
muQ2 <- 0.1540352 #0.1629413 #0.1587045 #0.163 #0.166 #0.18 #0.22
muQ3 <- 0.1854509 #0.1770267 #0.1758627 #0.177 #0.179 #0.223 #0.22
muQ4 <- 0.04811235 #0.05811899 #0.05711325 #0.0582 #0.0612 #0.09 #0.22 #0.165
muQ5 <- 0.112054 #0.1279527 #0.1313124 #0.128 #0.128 #0.12 #0.135 #0.05

muK1 <- 88.32204 #75.48489 #75.69238 #75.6 #70 #53.8 #49.8
muK2 <- 12.5566 #10.83212 #11.34571 #10.8 #9.87 #8.8 #6.49
muK3 <- 3.3063 #3.391654 #3.496804 #3.4 #3.19 #2.63 #2.41
muK4 <- 9.136767 #8.281045 #8.382135 #8.28 #8.04 #4.83 #2.14 #2.5
muK5 <- 7.627945 #6.752648 #6.763815 #6.77 #6.54 #7.35 #6.36 #10.25

muH1 <- 60.58361 #53.64355 #53.79338 #53.7 #50.4 #40.46 #37.03
muH2 <- 10.51548 #9.506736 #9.771146 #9.49 #8.76 #8 #6.75
muH3 <- 3.27071 #3.187564 #3.274489 #3.19 #3 #2.9 #2.61
muH4 <- 5.373999 #4.940765 #4.991676 #4.94 #4.81 #3.2 #2.27 #2.18
muH5 <- 5.411617 #4.972467 #4.995162 #4.98 #4.87 #5.3 #4.88 #6 

muI1 <- 0
muI2 <- 0.1266553 #0.1252565 #0.1295001 #0.126 #0.126 #0.125
muI3 <- 0.7247971 #0.7485214 #0.7489688 #0.769 #0.762 #0.75
muI4 <- 2.182795 #1.750699 #1.773671 #1.84 #1.79 #1.75 #3.75 #2.75
muI5 <- 10.80738 #8.823956 #8.894477 #8.83 #8.68 #8.75 #10.75 #3.75
...
iexpLQ1 <- 0.005 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.0005 #0.001 ##0.0015     # mean(post5$"offsetIndivStdevs[1]")
iexpLQ2 <- 0.005 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.0005 #0.001 ##0.0015        
iexpLQ3 <- 0.05 #0.005 #0.05 #0.01 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.0005 #0.001 #0.01 ##0.005 
iexpLQ4 <- 0.05 #0.005 #0.05 #0.1 #0.05 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.00001 #0.00005 #0.0001 #0.0005 #0.001 ##0.0015          
iexpLQ5 <- 0.05 #0.005 #0.05 #0.1 #0.05 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.00001 #0.00005 #0.0001 #0.0005 #0.001 #0.01 ##0.005 

iexpLK1 <- 0.005 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.001 #0.005 ##0.006      
iexpLK2 <- 0.005 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.001 #0.001 #0.005 ##0.006 
iexpLK3 <- 0.05 #0.005 #0.05 #0.01 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.001 #0.001 #0.005 #0.06 ##0.01  
iexpLK4 <- 0.05 #0.005 #0.05 #0.1 #0.05 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.00005 #0.0001 #0.0005 #0.001 #0.005 ##0.006  
iexpLK5 <- 0.05 #0.005 #0.05 #0.1 #0.05 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.00005 #0.0001 #0.0005 #0.001 #0.005 #0.06 ##0.01 
...
iexpR3 <- 0.05 #0.005 #0.05 #0.01 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.001 #0.005 #0.01 #0.15 ##0.05 #0.015
iexpR4 <- 0.05 #0.005 #0.05 #0.1 #0.05 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.0001 #0.0005 #0.001 #0.005 #0.01 ##0.015 #0.015 
iexpR5 <- 0.05 #0.005 #0.05 #0.1 #0.05 #0.008 #0.005 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.0001 #0.0005 #0.001 #0.005 #0.01 #0.15 ##0.05 #0.005
...
# on transformed scale 
ihsdLQ1 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdLQ2 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01        
ihsdLQ3 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdLQ4 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01          
ihsdLQ5 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01 

ihsdLK1 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01     
ihsdLK2 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01 
ihsdLK3 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01  
ihsdLK4 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01  
ihsdLK5 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01 

ihsdR1 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01      
ihsdR2 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdR3 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdR4 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdR5 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01

ihsdLI1 <- 0.0000001      
ihsdLI2 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdLI3 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdLI4 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdLI5 <- 0.01 #0.005 #0.1 #0.01 #0.005 #0.01 #0.005 #0.01 #0.001 #0.000001 #0.0001 #0.01
ihsdLIM <- 0.0000001
