...
model {
  ...
  // the variance for the unlogged height is ( e^sigma^2 - 1 )*( e^( 2*log(mu) + sigma^2 ) ), i.e., variance of a log-normally distributed random variable: https://en.wikipedia.org/wiki/Log-normal_distribution
}
