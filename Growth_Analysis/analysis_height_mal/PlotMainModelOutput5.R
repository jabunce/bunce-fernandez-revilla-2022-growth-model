...
symbol.Male(centerx = 23, centery = max(abs(rowMeans(conQ))), rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
symbol.Male(centerx = 23, centery = max(abs(rowMeans(conK))), rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
symbol.Male(centerx = 23, centery = max(abs(rowMeans(conH))), rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
