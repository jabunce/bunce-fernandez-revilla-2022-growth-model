...
parameters {
  ...
  vector<lower=0,upper=5>[5] muLK;        // upper limit = e^5 = 148
  ...
  real<lower=0,upper=0.005> Lsigma;        //0.01 0.005  variance of the logged normal distribution, upper limit of 0.005 yields 95% of observations within 2*stdev = 1cm of actual height at 100cm 
}
