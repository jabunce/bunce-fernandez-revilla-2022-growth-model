...
symbol.Female(centerx = 0.09, centery = 1.1, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
symbol.Female(centerx = mean( (2*H1mat/K1mat)^(1/Q1mat) ) - 5 + 14,
