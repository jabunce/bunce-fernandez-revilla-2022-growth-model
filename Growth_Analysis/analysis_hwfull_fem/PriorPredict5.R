...
muQ1 <- 0.0870396 #0.08653492 #0.08613371 #0.08619359 #0.0864 #0.088 #0.098 #0.094
muQ2 <- 0.1772943 #0.1692538 #0.1629413 #0.1587045 #0.163 #0.166 #0.18 #0.22
muQ3 <- 0.2194304 #0.2088067 #0.2394337 #0.23 #0.1770267 #0.1758627 #0.177 #0.179 #0.223 #0.22
muQ4 <- 0.3479849 #0.344921 #0.4072768 #0.33 #0.05811899 #0.05711325 #0.0582 #0.0612 #0.09 #0.22 #0.165
muQ5 <- 0.4475974 #0.4512731 #0.4802057 #0.49 #0.1279527 #0.1313124 #0.128 #0.128 #0.12 #0.135 #0.05

muK1 <- 79.0056 #79.48879 #75.48489 #75.69238 #75.6 #70 #53.8 #49.8
muK2 <- 11.44331 #11.25908 #10.83212 #11.34571 #10.8 #9.87 #8.8 #6.49
muK3 <- 3.627715 #3.945743 #2.815028 #3.65 #3.391654 #3.496804 #3.4 #3.19 #2.63 #2.41
muK4 <- 1.656987 #1.609368 #1.851658 #1.57 #8.281045 #8.382135 #8.28 #8.04 #4.83 #2.14 #2.5
muK5 <- 2.840083 #2.801749 #3.099612 #3 #6.752648 #6.763815 #6.77 #6.54 #7.35 #6.36 #10.25

muH1 <- 56.16734 #56.40467 #53.64355 #53.79338 #53.7 #50.4 #40.46 #37.03
muH2 <- 10.22976 #10.08134 #9.506736 #9.771146 #9.49 #8.76 #8 #6.75
muH3 <- 3.905692 #4.074629 #3.345123 #4 #3.187564 #3.274489 #3.19 #3 #2.9 #2.61
muH4 <- 2.795355 #2.731963 #3.360202 #2.57 #4.940765 #4.991676 #4.94 #4.81 #3.2 #2.27 #2.18
muH5 <- 5.049444 #5.027771 #5.420606 #5.8 #4.972467 #4.995162 #4.98 #4.87 #5.3 #4.88 #6 

muI1 <- 0
muI2 <- 0.1255301 #0.1261734 #0.1252565 #0.1295001 #0.126 #0.126 #0.125
muI3 <- 0.6091734 #0.6008812 #1.075584 #1.1 #0.7485214 #0.7489688 #0.769 #0.762 #0.75
muI4 <- 4.512747 #4.500285 #6.322133 #4.4 #1.750699 #1.773671 #1.84 #1.79 #1.75 #3.75 #2.75
muI5 <- 10.29105 #10.17578 #10.94817 #10.35 #8.823956 #8.894477 #8.83 #8.68 #8.75 #10.75 #3.75
