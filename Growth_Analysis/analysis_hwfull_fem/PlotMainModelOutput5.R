...
pdf(file="./Plots/Composite_model_sample_mat_ber_randeff_cov5w.pdf",
  ...
  # plot measurment points
  points(x=Ber.fem$TotAge, y=Ber.fem$CellWeightg, lwd=0.5, col="red", cex=0.5)
  points(x=Mat.fem$TotAge, y=Mat.fem$CellWeightg, lwd=0.5, col="blue", cex=0.5)
...
symbol.Female(centerx = 23, centery = 400, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
