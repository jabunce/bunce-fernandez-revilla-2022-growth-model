...
pdf(file="./Plots/Composite_model_sample_mat_ber_randeff_cov.pdf",
  ...
  points(x=Ber.fem$TotAge, y=Ber.fem$Weight, lwd=0.5, col="red", cex=0.5)
  points(x=Mat.fem$TotAge, y=Mat.fem$Weight, lwd=0.5, col="blue", cex=0.5)
...
symbol.Female(centerx = 5, centery = 10, rayonx=0.8, lwd=2, col="black") # Male symbol from HelpersMG package
...
symbol.Female(centerx = mean( pi*(2*H1ber/K1ber)^( ( 2*Q1ber + 1 )/Q1ber ) ) + 2,
